...
> Snapshot as of **2026-07-10** (v2.6.0). Versions compared:
...
| OpenRPC / service description | yes (generated + `rpc.discover`, default-deny visibility) | no | `rpc.serverInfo` (methods list) | no |
